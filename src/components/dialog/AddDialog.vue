    ...
    <Transition name="fade">
        <div class="flex fixed justify-center top-0 items-center w-screen h-screen">
            ...
            <div :class="width" :style="style"
                ...
                <form @submit.prevent="closeDialog(text)" class="flex flex-col gap-3 py-6">
                    <input v-model="text"
                           :type="type"
                ...
                <div class="flex gap-3 justify-end">
                    ...
                    <button @click="closeDialog(text)"
                            class="text-white rounded-full px-6 py-1.5 font-bold bg-primary-700 hover:bg-primary-800 transition-colors">
                        {{ action}}
                    </button>
                </div>
            </div>
