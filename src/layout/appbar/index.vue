<template>
    <div class="flex items-center gap-4 px-6 py-4 md:py-6">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 text-primary-600" viewBox="0 0 24 24">
        ...
        <h1 class="text-2xl font-bold">E-FARMING</h1>
    </div>
</template>
