                ...
                <form @submit.prevent="login" class="flex flex-col gap-3 py-6">
                    ...
                    <div>
                        <button type="submit"
                                ...
                                class="flex justify-center w-full text-center gap-4 py-3 px-5 transition-all   rounded  text-white">
